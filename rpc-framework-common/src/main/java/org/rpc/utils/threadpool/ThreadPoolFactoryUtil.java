package org.rpc.utils.threadpool;
...
public final class ThreadPoolFactoryUtil {
     ...
     * value: threadPool
     */
    private static final Map<String, ExecutorService> THREAD_POOLS = new ConcurrentHashMap<>(); //使用线程安全的ConcurrentHashMap
